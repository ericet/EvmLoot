...
contract EvmLoot is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "Bag #', toString(tokenId), '", "description": "EvmLoot is randomized adventurer gear generated and stored on Evmos-chain. Stats, images, and other functionality are intentionally omitted for others to interpret. You can use EvmLoot in any way you want.", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '"}'))));
    ...
    function claim(uint tokenAmount) public payable nonReentrant {
        ...
        for (uint i = 0; i < tokenAmount; i++) {
            ...
            require(publicMintedAmount < 10000, "No tokens available");
    ...
    constructor() ERC721("evmLoot", "EvmLoot") Ownable() {}
}
